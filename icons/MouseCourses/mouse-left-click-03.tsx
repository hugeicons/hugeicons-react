...
interface MouseLeftClick03IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MouseLeftClick03Icon = (props: MouseLeftClick03IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 11L6 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
