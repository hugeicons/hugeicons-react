...
interface MouseLeftClick05IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MouseLeftClick05Icon = (props: MouseLeftClick05IconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M10 2.31844C10.7306 2.11067 11.5601 2 12.5 2C18.5 2 20 6.50998 20 12C20 17.49 18.5 22 12.5 22C6.49993 22 5 17.49 5 12C5 11.4906 5.01291 10.9897 5.04113 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
