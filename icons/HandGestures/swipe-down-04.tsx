...
interface SwipeDown04IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SwipeDown04Icon = (props: SwipeDown04IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M18 8L18 2M18 8C17.2998 8 15.9915 6.0057 15.5 5.5M18 8C18.7002 8 20.0085 6.0057 20.5 5.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
