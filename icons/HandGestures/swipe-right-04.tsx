...
interface SwipeRight04IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SwipeRight04Icon = (props: SwipeRight04IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M20.5 4.5L14.5 4.5M20.5 4.5C20.5 3.79977 18.5057 2.49153 18 2M20.5 4.5C20.5 5.20023 18.5057 6.50847 18 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
