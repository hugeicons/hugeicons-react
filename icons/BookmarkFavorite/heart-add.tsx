...
interface HeartAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const HeartAddIcon = (props: HeartAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M14 17H22M18 13L18 21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
