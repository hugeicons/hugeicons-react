...
interface LocationAdd02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LocationAdd02Icon = (props: LocationAdd02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15.5 11H12M12 11H8.5M12 11V14.5M12 11L12 7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
