...
interface LocationUser02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LocationUser02Icon = (props: LocationUser02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M19 19C19 20.6569 15.866 22 12 22C8.13401 22 5 20.6569 5 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
