...
interface LocationRemove02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LocationRemove02Icon = (props: LocationRemove02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15.5 11H8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
