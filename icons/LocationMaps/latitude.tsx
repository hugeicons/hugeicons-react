...
interface LatitudeIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LatitudeIcon = (props: LatitudeIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M20 7L4 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
