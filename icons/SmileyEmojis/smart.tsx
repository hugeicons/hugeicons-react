...
interface SmartIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SmartIcon = (props: SmartIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M11 17.7844C13.6177 18.5609 15.9391 17.1496 17 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
