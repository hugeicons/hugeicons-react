...
interface SidebarTopIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SidebarTopIcon = (props: SidebarTopIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2 9.5L22 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M6 6H7M10 6H11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
