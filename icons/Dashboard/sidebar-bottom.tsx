...
interface SidebarBottomIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SidebarBottomIcon = (props: SidebarBottomIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2 14.5L22 14.5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M6 18H7M10 18H11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
