...
interface BubbleChatNotificationIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const BubbleChatNotificationIcon = (props: BubbleChatNotificationIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M23 5.5C23 7.433 21.433 9 19.5 9C17.567 9 16 7.433 16 5.5C16 3.567 17.567 2 19.5 2C21.433 2 23 3.567 23 5.5Z" stroke="currentColor" strokeWidth="1.5" />
