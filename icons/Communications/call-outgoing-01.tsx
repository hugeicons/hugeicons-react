...
interface CallOutgoing01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallOutgoing01Icon = (props: CallOutgoing01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21 5.5L13 5.5M21 5.5C21 6.20023 19.0057 7.50847 18.5 8M21 5.5C21 4.79977 19.0057 3.49153 18.5 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
