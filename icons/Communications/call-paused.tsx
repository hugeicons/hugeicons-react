...
interface CallPausedIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallPausedIcon = (props: CallPausedIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M20 3V10M14 3V10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
