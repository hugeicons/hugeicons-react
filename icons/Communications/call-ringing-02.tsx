...
interface CallRinging02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallRinging02Icon = (props: CallRinging02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M14 3V5.8M18.9502 5.05078L16.9703 7.03068M21 10H18.2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
