...
interface CallIncoming02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallIncoming02Icon = (props: CallIncoming02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M13.2269 10.7731L20 4M13.2269 10.7731C13.7322 11.2784 16.1154 10.7834 16.8351 10.7731M13.2269 10.7731C12.7216 10.2678 13.2166 7.88456 13.2269 7.16492" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
