...
interface CallRinging01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallRinging01Icon = (props: CallRinging01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 4V6.85714M18 7.57143L15.6001 9M6 7.57143L8.39987 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
