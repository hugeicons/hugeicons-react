...
interface CallAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallAddIcon = (props: CallAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 3V11M21 7L13 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
