...
interface CallMinusIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallMinusIcon = (props: CallMinusIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21 7L13 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
