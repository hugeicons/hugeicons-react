...
interface MessageCancel01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MessageCancel01Icon = (props: MessageCancel01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 2L22.0001 8M16 8L22.0001 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
