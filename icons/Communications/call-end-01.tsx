...
interface CallEnd01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallEnd01Icon = (props: CallEnd01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21 3L14 10M21 10L14 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
