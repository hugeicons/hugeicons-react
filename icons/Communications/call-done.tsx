...
interface CallDoneIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CallDoneIcon = (props: CallDoneIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 9C12 9 13 9 14 11C14 11 17.1765 6 20 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
