...
interface MessageEdit02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MessageEdit02Icon = (props: MessageEdit02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M11.9955 12.5H12.0044M8 12.5H8.00897" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
