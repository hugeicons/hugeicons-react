...
interface MessagePreview01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MessagePreview01Icon = (props: MessagePreview01IconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M8.5 15.5H15.5M8.5 10.5H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
