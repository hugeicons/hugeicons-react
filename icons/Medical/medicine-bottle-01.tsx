...
interface MedicineBottle01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MedicineBottle01Icon = (props: MedicineBottle01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 13V18M9.5 15.5L14.5 15.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
