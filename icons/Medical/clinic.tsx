...
interface ClinicIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ClinicIcon = (props: ClinicIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 10V16M9 13L15 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
