...
interface SaveEnergy02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SaveEnergy02Icon = (props: SaveEnergy02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M18.5 15L16 18.5H20L17.5 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
