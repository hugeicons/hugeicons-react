...
interface AutomotiveBattery02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AutomotiveBattery02Icon = (props: AutomotiveBattery02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12.5 9L10 13H14L11.5 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
