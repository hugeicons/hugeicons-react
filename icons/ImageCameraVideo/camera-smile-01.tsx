...
interface CameraSmile01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CameraSmile01Icon = (props: CameraSmile01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M9 12H9.00897M14.991 12H15M9.9987 16C9.9987 16 10.7476 17 11.9957 17C13.2438 17 13.9927 16 13.9927 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
