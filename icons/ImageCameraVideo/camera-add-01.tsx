...
interface CameraAdd01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CameraAdd01Icon = (props: CameraAdd01IconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M8.5 14.5H15.5M12 18L12 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
