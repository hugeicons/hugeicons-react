...
interface KeyframeRemoveIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const KeyframeRemoveIcon = (props: KeyframeRemoveIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 5H22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
