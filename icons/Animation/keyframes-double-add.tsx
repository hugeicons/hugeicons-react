...
interface KeyframesDoubleAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const KeyframesDoubleAddIcon = (props: KeyframesDoubleAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M5.5 15.5L5.5 8.5M2 12H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
