...
interface EraserAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const EraserAddIcon = (props: EraserAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M11 8V16M15 12L7 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
