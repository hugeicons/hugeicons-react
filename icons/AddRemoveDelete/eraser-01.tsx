...
interface Eraser01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Eraser01Icon = (props: Eraser01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M14 9L8 14.9996M14 15L8 9.00039" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
