...
interface ShoppingBasketCheckOut02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ShoppingBasketCheckOut02Icon = (props: ShoppingBasketCheckOut02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 19.5C16.4915 20.0057 17.7998 22 18.5 22M21 19.5C20.5085 20.0057 19.2002 22 18.5 22M18.5 22V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
