...
interface ShoppingCartCheck02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ShoppingCartCheck02Icon = (props: ShoppingCartCheck02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M6 6L7.5 6M22 6H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
