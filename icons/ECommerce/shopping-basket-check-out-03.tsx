...
interface ShoppingBasketCheckOut03IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ShoppingBasketCheckOut03Icon = (props: ShoppingBasketCheckOut03IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 18.5C16.4915 19.0057 17.7998 21 18.5 21M21 18.5C20.5085 19.0057 19.2002 21 18.5 21M18.5 21V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
