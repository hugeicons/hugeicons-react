...
interface ShoppingCartCheckOut02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ShoppingCartCheckOut02Icon = (props: ShoppingCartCheckOut02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M6 6H8M22 6H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M11 5.5C11.4915 4.9943 12.7998 3 13.5 3M16 5.5C15.5085 4.9943 14.2002 3 13.5 3M13.5 3V11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
