...
interface CreditCardNotAcceptIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const CreditCardNotAcceptIcon = (props: CreditCardNotAcceptIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M22 14L16 20M22 20L16 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
