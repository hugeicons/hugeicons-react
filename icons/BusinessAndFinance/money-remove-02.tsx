...
interface MoneyRemove02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MoneyRemove02Icon = (props: MoneyRemove02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 18H22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
