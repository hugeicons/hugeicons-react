...
interface MoneyNotFound02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const MoneyNotFound02Icon = (props: MoneyNotFound02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M13.7418 13.7422C13.2876 14.2094 12.6523 14.4996 11.9492 14.4996C10.5685 14.4996 9.44922 13.3803 9.44922 11.9996C9.44922 11.2966 9.73945 10.6613 10.2066 10.207" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
