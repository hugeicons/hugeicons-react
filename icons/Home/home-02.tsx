...
interface Home02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Home02Icon = (props: Home02IconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M12.0001 18L12.0001 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
