...
interface FingerPrintAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const FingerPrintAddIcon = (props: FingerPrintAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M17.5 16.6667V18M17.5 18V19.3333M17.5 18H18.8333M17.5 18H16.1667M21.5 18C21.5 20.2091 19.7091 22 17.5 22C15.2909 22 13.5 20.2091 13.5 18C13.5 15.7909 15.2909 14 17.5 14C19.7091 14 21.5 15.7909 21.5 18Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
