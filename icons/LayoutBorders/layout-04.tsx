...
interface Layout04IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Layout04Icon = (props: Layout04IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21.5 12L9 12" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    </>
  );
};
