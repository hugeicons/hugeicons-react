...
interface Layout02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Layout02Icon = (props: Layout02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21.5 9L2.5 9" stroke="currentColor" strokeWidth="1.5" />
        <path d="M16 21.5L16 9" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    </>
  );
};
