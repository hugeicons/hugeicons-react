...
interface BorderVerticalIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const BorderVerticalIcon = (props: BorderVerticalIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M9.15 12H14.85M19.6 12L21.5 12M2.5 12H4.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 2.5L12 21.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
