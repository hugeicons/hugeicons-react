...
interface Layout2RowIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Layout2RowIcon = (props: Layout2RowIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21.5 12L2.50078 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
