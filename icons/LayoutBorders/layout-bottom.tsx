...
interface LayoutBottomIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LayoutBottomIcon = (props: LayoutBottomIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21.5 15L2.5 15" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    </>
  );
};
