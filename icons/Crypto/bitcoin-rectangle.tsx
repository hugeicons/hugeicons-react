...
interface BitcoinRectangleIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const BitcoinRectangleIcon = (props: BitcoinRectangleIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M9.5 12L14.5 12C15.3284 12 16 12.6716 16 13.5V14.5C16 15.3284 15.3284 16 14.5 16H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
