...
interface FileAttachmentIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const FileAttachmentIcon = (props: FileAttachmentIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M3.5 8.23077V5.46154C3.5 3.54978 5.067 2 7 2C8.933 2 10.5 3.54978 10.5 5.46154L10.5 9.26923C10.5 10.2251 9.7165 11 8.75 11C7.7835 11 7 10.2251 7 9.26923L7 5.46154" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
