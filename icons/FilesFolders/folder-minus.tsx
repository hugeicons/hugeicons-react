...
interface FolderMinusIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const FolderMinusIcon = (props: FolderMinusIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M22 17.5L14 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
