...
interface FileMinusIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const FileMinusIcon = (props: FileMinusIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M11 6L3 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
