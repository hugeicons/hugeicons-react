...
const FileDownloadIcon = (props: FileDownloadIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M4.5 7.5C4.99153 8.0057 6.29977 10 7 10M9.5 7.5C9.00847 8.0057 7.70023 10 7 10M7 10L7 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
