...
interface UserUnlock02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const UserUnlock02Icon = (props: UserUnlock02IconProps) => {
