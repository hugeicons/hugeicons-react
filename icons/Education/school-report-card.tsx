...
interface SchoolReportCardIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SchoolReportCardIcon = (props: SchoolReportCardIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 13L14.1429 11M9 13L9.85714 11M9.85714 11L11.4076 7.38235C11.5067 7.15092 11.7406 7 12 7C12.2594 7 12.4933 7.15092 12.5924 7.38235L14.1429 11M9.85714 11H14.1429" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
