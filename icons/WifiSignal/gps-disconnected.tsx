...
interface GpsDisconnectedIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const GpsDisconnectedIcon = (props: GpsDisconnectedIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M22 8L19 5M19 5L16 2M19 5L16 8M19 5L22 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
