...
interface SignalFull01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SignalFull01Icon = (props: SignalFull01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M9 14V19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        ...
        <path d="M21 7L21 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
