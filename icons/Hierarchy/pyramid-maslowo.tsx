...
interface PyramidMaslowoIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const PyramidMaslowoIcon = (props: PyramidMaslowoIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M3.5 15H9M20.5 15H15M7 9H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 9L12 21" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    </>
  );
};
