...
interface Sofa02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Sofa02Icon = (props: Sofa02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 4L12 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
