...
interface SunCloudMidSnow01IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const SunCloudMidSnow01Icon = (props: SunCloudMidSnow01IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 14V20M14.5 15.5L9.50013 18.5M9.5 15.5L14.4999 18.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
