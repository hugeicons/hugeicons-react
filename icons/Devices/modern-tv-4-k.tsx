...
interface ModernTvFourKIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const ModernTvFourKIcon = (props: ModernTvFourKIconProps) => {
  ...
  return (
    <>
      ...
      >
        <path d="M10.5 7V10M10.5 10V13M10.5 10H8.5C7.55719 10 7.08579 10 6.79289 9.70711C6.5 9.41421 6.5 8.94281 6.5 8V7M13.5 13V10M13.5 10V7M13.5 10L17.5 7M13.5 10L17.5 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
