...
interface LaptopChargingIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LaptopChargingIcon = (props: LaptopChargingIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12.4626 6L11.0685 7.81238C10.9192 8.0066 11.0262 8.28605 11.2698 8.33776L12.7301 8.64772C12.9898 8.70285 13.0889 9.01223 12.9073 9.2011L11.1777 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
