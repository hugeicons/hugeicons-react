...
interface LaptopAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const LaptopAddIcon = (props: LaptopAddIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M20 15V13M4 15V7C4 5.11438 4 4.17157 4.58579 3.58579C5.17157 3 6.11438 3 8 3H11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
