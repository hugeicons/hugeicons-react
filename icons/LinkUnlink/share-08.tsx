...
interface Share08IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Share08Icon = (props: Share08IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8.72852 10.7497L15.2285 7.75024M8.72852 13.2502L15.2285 16.2497" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    </>
  );
};
