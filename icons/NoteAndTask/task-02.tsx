...
interface Task02IconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const Task02Icon = (props: Task02IconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 16H12M8 11H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
