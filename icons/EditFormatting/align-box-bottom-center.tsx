...
interface AlignBoxBottomCenterIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxBottomCenterIcon = (props: AlignBoxBottomCenterIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 12H8M13.5 17H10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
