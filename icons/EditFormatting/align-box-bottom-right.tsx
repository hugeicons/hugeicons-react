...
interface AlignBoxBottomRightIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxBottomRightIcon = (props: AlignBoxBottomRightIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 12L9 12M17 17H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
