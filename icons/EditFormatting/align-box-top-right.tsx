...
interface AlignBoxTopRightIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxTopRightIcon = (props: AlignBoxTopRightIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 7L9 7M17 12H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
