...
interface FlipVerticalIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const FlipVerticalIcon = (props: FlipVerticalIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M10 12H14M17.5 12H21M3 12H6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </>
  );
};
