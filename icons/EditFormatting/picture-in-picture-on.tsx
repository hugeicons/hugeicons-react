...
interface PictureInPictureOnIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const PictureInPictureOnIcon = (props: PictureInPictureOnIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M11 9.5V12C11.0475 12.5744 10.6034 13.0238 10 13H7.5M6 8L10 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
