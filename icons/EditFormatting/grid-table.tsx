...
interface GridTableIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const GridTableIcon = (props: GridTableIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2.5 15L21.5 15" stroke="currentColor" strokeWidth="1.5" />
        <path d="M16 21.5L16 2.5" stroke="currentColor" strokeWidth="1.5" />
        <path d="M8 21.5L8 2.5" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    </>
  );
};
