...
interface AlignBoxTopLeftIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxTopLeftIcon = (props: AlignBoxTopLeftIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 7L7 7M10 12H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
