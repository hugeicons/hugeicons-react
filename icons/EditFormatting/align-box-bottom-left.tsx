...
interface AlignBoxBottomLeftIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxBottomLeftIcon = (props: AlignBoxBottomLeftIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 12L7 12M10 17H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
