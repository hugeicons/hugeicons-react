...
interface AlignBoxMiddleRightIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxMiddleRightIcon = (props: AlignBoxMiddleRightIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 9.5L9 9.5M17 14.5H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
