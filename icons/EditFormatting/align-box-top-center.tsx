...
interface AlignBoxTopCenterIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AlignBoxTopCenterIcon = (props: AlignBoxTopCenterIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 7H8M13.5 12H10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  );
};
