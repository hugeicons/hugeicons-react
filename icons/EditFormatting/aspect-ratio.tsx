...
interface AspectRatioIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  rotate?: number;
  animate?: boolean;
}

const AspectRatioIcon = (props: AspectRatioIconProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2 9H10C12.8284 9 14.2426 9 15.1213 9.87868C16 10.7574 16 12.1716 16 15V21" stroke="currentColor" strokeWidth="1.5" />
